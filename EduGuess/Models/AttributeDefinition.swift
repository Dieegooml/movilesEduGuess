...
extension AttributeDefinition {
    static let pool: [AttributeDefinition] = [
        ...
        .init(key: "isBoxer", questionTemplates: [
            "¿Tu personaje es boxeador?",
            "¿Pelea en un ring?",
            "¿Usa guantes de boxeo?",
            "¿Es un luchador de boxeo?",
            "¿Golpea en un cuadrilátero?",
        ]),
        .init(key: "isTennisPlayer", questionTemplates: [
            "¿Tu personaje es tenista?",
            "¿Juega tenis profesionalmente?",
            "¿Usa raqueta?",
            "¿Es conocido por el tenis?",
            "¿Juega en canchas de tenis?",
        ]),
        .init(key: "isBasketballPlayer", questionTemplates: [
            "¿Tu personaje es jugador de baloncesto?",
            "¿Juega básquetbol profesionalmente?",
            "¿Encesta en una cancha?",
            "¿Es muy alto y juega básquet?",
            "¿Es de la NBA?",
        ]),
        .init(key: "isSwimmer", questionTemplates: [
            "¿Tu personaje es nadador?",
            "¿Nada profesionalmente?",
            "¿Compite en piscinas?",
            "¿Es conocido por la natación?",
            "¿Gana medallas en natación?",
        ]),
        .init(key: "isOlympian", questionTemplates: [
            "¿Tu personaje ha competido en Juegos Olímpicos?",
            "¿Es olímpico?",
            "¿Ha ganado medallas olímpicas?",
            "¿Participó en Olimpiadas?",
            "¿Representa a su país en los Juegos Olímpicos?",
        ]),
